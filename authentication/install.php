...
// Prompt user to reset migrations if required
echo "Do you want to reset the migrations and apply the missing ones? (Y/N): ";
...
if (strtoupper($response) === 'Y') {
    ...
    foreach ($files as $file) {
        if (strpos($file->getFilename(), '_add_two_factor_columns_to_users_table.php') !== false ||
            strpos($file->getFilename(), '_create_users_table.php') !== false ||
            strpos($file->getFilename(), '_create_cache_table.php') !== false ||
            strpos($file->getFilename(), '_create_jobs_table.php') !== false) {
